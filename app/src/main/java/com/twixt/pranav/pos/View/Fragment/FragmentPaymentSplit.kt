...
class FragmentPaymentSplit : Fragment() {
    ...
    lateinit var paying_amounts_a1: CurrencyEditText
    lateinit var paying_amounts_a2: CurrencyEditText
    lateinit var paying_amounts_a3: CurrencyEditText
    lateinit var paying_amounts_a4: CurrencyEditText
    lateinit var paying_amounts_a5: CurrencyEditText
    lateinit var paying_amounts_a6: CurrencyEditText
    lateinit var paying_amounts_a7: CurrencyEditText
    lateinit var paying_amounts_a8: CurrencyEditText
    lateinit var paying_amounts_a9: CurrencyEditText
    lateinit var paying_amounts_a10: CurrencyEditText
    ...
    val d_reverse = DecimalFormat("#,###,##0.00")
...
//        RequestcheckingNetwork(activity, ResponceprocesrWifi()).getStatus()
        ...
        try {
            if (decimal_format.format(dot_comma_int).toDouble() == 1.1) {
                ...
                paying_amounts_a1.setGroupDivider(',')
                paying_amounts_a1.setMonetaryDivider('.')

                paying_amounts_a2.setGroupDivider(',')
                paying_amounts_a2.setMonetaryDivider('.')

                paying_amounts_a3.setGroupDivider(',')
                paying_amounts_a3.setMonetaryDivider('.')

                paying_amounts_a4.setGroupDivider(',')
                paying_amounts_a4.setMonetaryDivider('.')

                paying_amounts_a5.setGroupDivider(',')
                paying_amounts_a5.setMonetaryDivider('.')

                paying_amounts_a6.setGroupDivider(',')
                paying_amounts_a6.setMonetaryDivider('.')

                paying_amounts_a7.setGroupDivider(',')
                paying_amounts_a7.setMonetaryDivider('.')

                paying_amounts_a8.setGroupDivider(',')
                paying_amounts_a8.setMonetaryDivider('.')

                paying_amounts_a9.setGroupDivider(',')
                paying_amounts_a9.setMonetaryDivider('.')

                paying_amounts_a10.setGroupDivider(',')
                paying_amounts_a10.setMonetaryDivider('.')
...
/*paying_amounts_a1.addTextChangedListener(object : TextWatcher {
override fun afterTextChanged(p0: Editable?) {
*//*var i = 2
while (i < p0.toString().length) {
    if (p0?.get(i) !== replace_String[0]) {
        p0!!.insert(i, replace_String)
    }
    i += 3
}*//*
...
if (p0!!.length > 0 && (p0!!.length % 5) == 0) {
    val c = p0.get(p0!!.length - 1)
    if (c.equals(" ")) {
...
if (p0!!.length > 0 && p0!!.length % 5 == 0) {
    ...
    if (Character.isDigit(c) && TextUtils.split(p0.toString(), String.valueOf(" ")).length <= 3) {
        p0.insert(p0.length - 1, String.valueOf(" "))
    }
...
rv_split.layoutManager = LinearLayoutManager(activity, LinearLayoutManager.VERTICAL, false)*/
        ...
        pay_a10.setOnClickListener(View.OnClickListener {
            if (paying_amounts_a10.text.toString().trim().length == 0) {
                ...
                if (d_reverse.format((paying_amounts_a10.text.toString().replace(replace_String, "")).toDouble()).replace(",", ".").toDouble() <= 0) {
                    message.setText(cu.getString(cu.getColumnIndex("ENTEER_AMOUNT")).toString())
                    popup.show()
                    ok.setOnClickListener(View.OnClickListener { popup.dismiss() })
                    ...
                    if (card_type_a10.getSelectedItemPosition() == 0) {
                        ...
                        if (amount >= d_reverse.format((paying_amounts_a10.text.toString().replace(",", ".")).toDouble()).replace(",", ".").toDouble()) {
                            ...
                            if (d_reverse.format(((remaning_amount.text.toString().replace(replace_String, "")).toString().replace(",", ".")).toDouble()).replace(",", ".").toDouble() <= 0.1) {
...
//                        }
        ...
        pay_a9.setOnClickListener(View.OnClickListener {
            if (paying_amounts_a9.text.toString().trim().length == 0) {
                ...
                if (d_reverse.format((paying_amounts_a9.text.toString().replace(replace_String, "")).toDouble()).replace(",", ".").toDouble() <= 0) {
                    message.setText(cu.getString(cu.getColumnIndex("ENTEER_AMOUNT")).toString())
                    popup.show()
                    ok.setOnClickListener(View.OnClickListener { popup.dismiss() })
                    ...
                    if (card_type_a9.getSelectedItemPosition() == 0) {
                        ...
                        if (amount >= d_reverse.format((paying_amounts_a9.text.toString().replace(",", ".")).toDouble()).replace(",", ".").toDouble()) {
                            ...
                            if (d_reverse.format(((remaning_amount.text.toString().replace(replace_String, "")).replace(",", ".")).toDouble()).replace(",", ".").toDouble() <= 0.1) {
                                checkout.visibility = View.VISIBLE
                                count.visibility = View.INVISIBLE
                                if (pay_a1.isEnabled != false) {
                                    relative_layout_a1.visibility = View.GONE
...
//                        }
        ...
        pay_a8.setOnClickListener(View.OnClickListener {
            if (paying_amounts_a8.text.toString().trim().length == 0) {
                ...
                if (d_reverse.format((paying_amounts_a8.text.toString().replace(replace_String, "")).toDouble()).replace(",", ".").toDouble() <= 0) {
                    message.setText(cu.getString(cu.getColumnIndex("ENTEER_AMOUNT")).toString())
                    popup.show()
                    ok.setOnClickListener(View.OnClickListener { popup.dismiss() })
...
//                        }
        ...
        pay_a7.setOnClickListener(View.OnClickListener {
            if (paying_amounts_a7.text.toString().trim().length == 0) {
                ...
                if (d_reverse.format((paying_amounts_a7.text.toString().replace(replace_String, "")).toDouble()).replace(",", ".").toDouble() <= 0) {
                    message.setText(cu.getString(cu.getColumnIndex("ENTEER_AMOUNT")).toString())
                    popup.show()
                    ok.setOnClickListener(View.OnClickListener { popup.dismiss() })
...
//                        }
        ...
        pay_a6.setOnClickListener(View.OnClickListener {
            if (paying_amounts_a6.text.toString().trim().length == 0) {
                ...
                if (d_reverse.format((paying_amounts_a6.text.toString().replace(replace_String, "")).toDouble()).replace(",", ".").toDouble() <= 0) {
                    message.setText(cu.getString(cu.getColumnIndex("ENTEER_AMOUNT")).toString())
                    popup.show()
                    ok.setOnClickListener(View.OnClickListener { popup.dismiss() })
...
//                        }
        ...
        pay_a5.setOnClickListener(View.OnClickListener {
            if (paying_amounts_a5.text.toString().trim().length == 0) {
                ...
                if (d_reverse.format((paying_amounts_a5.text.toString().replace(replace_String, "")).toDouble()).replace(",", ".").toDouble() <= 0) {
                    message.setText(cu.getString(cu.getColumnIndex("ENTEER_AMOUNT")).toString())
                    popup.show()
                    ok.setOnClickListener(View.OnClickListener { popup.dismiss() })
...
//                        }
        ...
        pay_a4.setOnClickListener(View.OnClickListener {
            if (paying_amounts_a4.text.toString().trim().length == 0) {
                ...
                if (d_reverse.format((paying_amounts_a4.text.toString().replace(replace_String, "")).toDouble()).replace(",", ".").toDouble() <= 0) {
                    message.setText(cu.getString(cu.getColumnIndex("ENTEER_AMOUNT")).toString())
                    popup.show()
                    ok.setOnClickListener(View.OnClickListener { popup.dismiss() })
                ...
                if ((d_reverse.format(((paying_amounts_a3.text.toString().replace(replace_String, "")).replace(",", ".")).toDouble()).replace(replace_String, "")).replace(",", ".").toDouble() <= 0) {
                    ...
                    if (card_type_a3.getSelectedItemPosition() == 0) {
                        ...
                        if (amount >= (d_reverse.format(((paying_amounts_a3.text.toString().replace(replace_String, "")).replace(",", ".")).toDouble()).replace(replace_String, "")).replace(",", ".").toDouble()) {
                            ...
                            if ((d_reverse.format(((remaning_amount.text.toString().replace(replace_String, "")).replace(",", ".")).toDouble()).replace(replace_String, "")).replace(",", ".").toDouble() <= 0.1) {
                                checkout.visibility = View.VISIBLE
                                count.visibility = View.INVISIBLE
                                if (pay_a1.isEnabled != false) {
                                    relative_layout_a1.visibility = View.GONE
